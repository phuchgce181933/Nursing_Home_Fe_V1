...
import {
  ...
  Hash, Users, MapPinned, LogOut, KeyRound, Eye, EyeOff,
} from 'lucide-react';
...
function AdminProfile() {
  ...
  const handleProfileSubmit = async (event) => {
    ...
    setMessage('');
    try {
      // If email changed, request OTP verification first (compare normalized)
  ...
  return (
    <div className="ap">
      ...
      <div className="ap-summary">
        <div className="ap-summary__card">
          <span className="ap-summary__label">{t('profile.email')}</span>
          <p className="ap-summary__value">{user.email}</p>
        </div>
        <div className="ap-summary__card">
          <span className="ap-summary__label">{t('profile.phoneNumber')}</span>
          <p className="ap-summary__value">{user.phone || '—'}</p>
        </div>
        <div className="ap-summary__card">
          <span className="ap-summary__label">{t('profile.roleCategory')}</span>
          <p className="ap-summary__value">{roleLabel}</p>
        </div>
        <div className="ap-summary__card">
          <span className="ap-summary__label">{t('profile.lastLogin')}</span>
          <p className="ap-summary__value">{formatDate(user.lastLoginAt)}</p>
        </div>
      </div>
                ...
                <section className="ap-section">
                  ...
                  <div className="ap-info-grid">
                    ...
                    <InfoField
                      ...
                      value={getGenderDisplay(user.gender, t)}
                    />
                  </div>
                </section>
              ...
              <form className="ap-form" onSubmit={handlePasswordSubmit}>
                <div className="ap-form__grid">
                  <FormField label={t('profile.currentPassword')} icon={Lock} full>
                    <div className="ap-form__input-wrap">
                      <input className="ap-form__input" type={showCurrentPassword ? 'text' : 'password'} required
                        value={passwordForm.currentPassword}
                        onChange={(e) => setPasswordForm(p => ({ ...p, currentPassword: e.target.value }))} />
                      <button
                        type="button"
                        className="ap-form__toggle"
