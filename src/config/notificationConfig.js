export const NOTIFICATION_CATEGORIES = ['incident', 'health', 'appointment', 'activity', 'billing', 'system'];
...
export const NOTIFICATION_TYPES = [
...

  {
    key: 'system',
    label: 'Hệ thống',
    description: 'Nhận thông báo về các sự kiện hệ thống',
  },
];

export const ROLE_NOTIFICATION_CONFIG = {
  family: {
    visibleCategories: ['incident', 'health', 'appointment', 'activity', 'billing', 'system'],
    canViewList: true,
    canMarkRead: true,
    canDelete: true,
    canFilter: true,
  ...
  admin: {
    visibleCategories: ['incident', 'activity', 'system'],
    canViewList: true,
    canMarkRead: true,
    canDelete: true,
    canFilter: true,
